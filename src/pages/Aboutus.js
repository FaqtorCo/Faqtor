...
export default function AboutUs() {
  ...
  return (
    <>
      ...
      <section className="mb-10 hero flex flex-col md:flex-row min-h-[450px] md:min-h-[520px] h-full items-center justify-between bg-black">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between w-full">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center h-full">
            <Fade direction="down" triggerOnce duration={600}>
              <h1 className="text-5xl sm:text-5xl font-bold leading-tight mb-5" style={{textShadow: 'none', color: '#daf7a7'}}>
                We don&apos;t chase trends.
              </h1>
              <h1 className="text-4xl sm:text-4xl font-bold leading-tight mb-6" style={{textShadow: 'none', color: '#daf7a7'}}>
          ...
          {/* Right side - Image */}
          <div className="w-full md:w-1/2 flex justify-center items-center h-full mt-16 md:mt-8">
            <Fade direction="down" triggerOnce duration={600}>
              <img
                src={aboutImage}
                alt="About us"
      ...
      <section id="mission" className="mb-16 bg-black">
      ...
      <section className="mb-16 overflow-x-auto bg-black">
      ...
      <section id="stats-section" className="mb-16 relative overflow-hidden bg-black">
        <div className="container mx-auto px-6">
      ...
      <section className="mb-16 relative overflow-hidden bg-black">
        {/* Background pattern */}
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-1/3">
              <Fade direction="left" triggerOnce>
                <div
                  className="rounded-xl overflow-hidden shadow-lg bg-[#181c16]"
                >
            ...
            <div className="lg:w-2/3">
              <Fade direction="right" triggerOnce>
                <div
                  className={`bg-[#181c16] rounded-2xl shadow-xl overflow-hidden h-full transition-all duration-500 ${
                    ...
                    <>
                      ...
                      <div className="h-64 relative overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 p-6 z-10">
                          <h3 className="text-2xl font-bold mb-2" style={{textShadow: 'none', color: '#daf7a7'}}>
                      ...
                      <div className="p-8">
                        ...
                        <div className="mb-6">
                          ...
                          <p className="ml-12" style={{textShadow: 'none', color: '#fff'}}>
                        ...
                        <div className="pt-6 border-t border-gray-100">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div
                              className="p-5 rounded-xl flex flex-col items-center justify-center text-center transition-transform hover:scale-105 border border-[#daf7a7]/30 bg-[#181c16]"
                            >
                              <BarChart2 size={28} className="mb-2" style={{ color: '#daf7a7' }} />
                              <p className="text-xs uppercase tracking-wider font-semibold mb-1 opacity-80" style={{textShadow: 'none', color: '#daf7a7'}}>
                                 Revenue Generated
                              </p>
                              <p className="text-2xl font-bold" style={{textShadow: 'none', color: '#fff'}}>
                            ...
                            <div
                              className="p-5 rounded-xl flex flex-col items-center justify-center text-center transition-transform hover:scale-105 border border-[#daf7a7]/30 bg-[#181c16]"
                            >
                              <Zap size={28} className="mb-2" style={{ color: '#daf7a7' }} />
                              <p className="text-xs uppercase tracking-wider font-semibold mb-1 opacity-80" style={{textShadow: 'none', color: '#daf7a7'}}>
                                 Efficiency Increase
                              </p>
                              <p className="text-2xl font-bold" style={{textShadow: 'none', color: '#fff'}}>
                            ...
                            <div
                              className="p-5 rounded-xl flex flex-col items-center justify-center text-center transition-transform hover:scale-105 border border-[#daf7a7]/30 bg-[#181c16]"
                            >
                              <Layers size={28} className="mb-2" style={{ color: '#daf7a7' }} />
                              <p className="text-xs uppercase tracking-wider font-semibold mb-1 opacity-80" style={{textShadow: 'none', color: '#daf7a7'}}>
                                 Key Metric
                              </p>
                              <p className="text-lg font-bold" style={{textShadow: 'none', color: '#fff'}}>
