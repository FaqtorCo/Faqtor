...
<section className="mb-0 relative bg-black">
  <div className="relative flex flex-col lg:flex-row items-center container mx-auto px-4">
    {/* Left side - Text content */}
    <div className="w-full lg:w-1/2 xl:pl-12 sm:pr-2 mt-2">
      <Fade direction="down" triggerOnce duration={600}>
        <h2 className="text-5xl sm:text-5xl font-bold leading-tight mb-5" style={{textShadow: 'none', color: '#daf7a7'}}>
          We don&apos;t chase trends.
        </h2>
        <p className="font-light text-xl leading-relaxed mb-12" style={{textShadow: 'none', color: '#fff'}}>
      ...
      <Fade direction="up" delay={500} triggerOnce>
        <Button
          ...
          className="flex w-71 h-18 items-center px-14 py-5 text-black text-xl bg-[#daf7a7] rounded-lg shadow-2xl hover:bg-dark-theme-[#daf7a7] transition duration-200"
        >
          Services
          <svg
    ...
    <div className="flex pt-5 md:w-fit w-full justify-center items-center order-first md:order-first lg:order-last lg:w-1/2">
      ...
      <section className="py-4 overflow-x-auto bg-black">
        <div className="container mx-auto px-6">
          <div className="text-center mb-7">
            <h2 className="text-4xl font-bold mb-1" style={{textShadow: 'none', color: '#daf7a7'}}>Core Beliefs</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 w-full">
            {coreBeliefs.map((belief, index) => (
              ...
              >
                <div
                  className="h-56 bg-[#181c16] rounded-xl shadow-lg p-5 text-center flex flex-col items-center justify-center transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl cursor-pointer overflow-hidden relative border border-[#daf7a7]/30 hover:border-[#daf7a7]"
                ...
                >
                  ...
                  <div
                    className="relative z-10 rounded-full p-3 mb-4 transform transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg"
                  ...
                  <h3
                    className="relative z-10 text-lg font-bold mb-2 transition-all duration-300 group-hover:transform group-hover:translate-y-1"
                    style={{ color: '#daf7a7', textShadow: 'none' }}
                  >
                    {belief.title}
                  </h3>
                  <p className="relative z-10 text-xs transition-colors duration-300 group-hover:text-gray-100" style={{textShadow: 'none', color: '#fff'}}>
                    {belief.description}
                  </p>
      ...
      <section id="stats-section" className="py-4 relative overflow-hidden bg-black">
        <div className="container mx-auto px-6">
          <div className="text-center mb-7">
            <h2 className="text-4xl font-bold mb-1" style={{textShadow: 'none', color: '#daf7a7'}}>Impact By Numbers</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              return (
                <div
                  key={index}
                  className="group w-full max-w-xs mx-auto bg-[#181c16] border border-[#daf7a7]/30 rounded-2xl shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 hover:border-[#daf7a7] flex flex-col items-center py-8 px-4 relative overflow-hidden"
                  style={{height: '100%'}}
                  onMouseEnter={() => setHoveredCard(index)}
                  onMouseLeave={() => setHoveredCard(null)}
                >
                  {/* Icon with brand color background */}
                  <div className="flex items-center justify-center w-16 h-16 mb-4 rounded-xl transition-all duration-300 group-hover:scale-110 group-hover:bg-[#23281c]" style={{backgroundColor: '#daf7a7'}}>
                  ...
                  {/* Label */}
                  <p className="text-base font-medium mb-4 text-center" style={{textShadow: 'none', color: '#fff'}}>{stat.label}</p>
                  {/* Progress Bar */}
        ...
        <div className="container mx-auto px-6 relative z-10">
          <Fade direction="down" triggerOnce>
            <div className="text-center mb-3">
              ...
              <p className="text-lg mb-1" style={{ color: "#fff", textShadow: 'none' }}>
...
<div className="lg:w-1/3 h-full flex flex-col">
  <Fade direction="left" triggerOnce>
    <div className="rounded-xl overflow-hidden shadow-lg bg-[#181c16] h-full flex flex-col min-h-[562px]">
      {caseStudies.map((study, index) => (
        <div
          key={study.id}
          className={`flex-1 p-6 cursor-pointer transition-all duration-300 border-l-4 min-h-[192px] ${
                      ...
                      <div className="p-3">
                        ...
                        <div className="pt-3 border-t border-gray-100">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                            <div
                              className="p-2 rounded-lg flex flex-col items-center justify-center text-center transition-transform hover:scale-105 border border-[#daf7a7]/30 bg-[#181c16] w-44 h-24"
                            >
