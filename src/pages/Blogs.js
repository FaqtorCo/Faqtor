...
function Blogs() {
  ...
  // Generate dynamic SEO data based on current category
  const getSEOData = () => {
    const blogCount = filteredBlogs.length;
    const latestBlogDate =
      filteredBlogs.length > 0 ? filteredBlogs[0].publishDate : null;

    let title = "Blog - Faqtor";
    let description =
      "Read our latest insights on AI, chatbots, automation, web development, and digital innovation. Stay updated with the latest trends and best practices.";
    let keywords =
      "ai chatbot, calling agent, automation, digital solutions, web development, technology consulting, artificial intelligence, conversational ai, voice agent, business automation, faqtor blog";

    if (selectedCategory !== "All") {
      title = `${selectedCategory} Blog - Faqtor`;
      description = `Explore our ${selectedCategory.toLowerCase()} articles covering AI, automation, and digital innovation. ${blogCount} articles available.`;
    ...
    <div className="blogs-page bg-black min-h-screen text-[#DAF7A6]">
      ...
      <div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <div className="mb-12 text-center">
          <h1 className="text-5xl md:text-5xl font-bold mb-6 text-[#DAF7A6]">
            Our Blogs
          </h1>
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            Discover insights on AI, automation, and digital transformation.
            {selectedCategory !== "All" &&
              ` Currently viewing ${selectedCategory} articles.`}
          </p>
        </div>
            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-2">
                  <p
                    className="text-sm font-medium text-[#DAF7A6] uppercase tracking-wider"
                ...
                <h2
                  className="text-xl font-bold mb-3 text-white line-clamp-2"
                  itemProp="headline"
                >
                  {blog.title}
                </h2>
                ...
                <p
                  className="text-gray-400 mb-5 line-clamp-3"
        ...
        {/* Subscribe Section */}
        <section className="mt-20 py-12 px-6 bg-gray-900 rounded-xl border border-gray-800">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4 text-[#DAF7A6]">
              Stay Updated
            </h2>
            <p className="text-gray-300 mb-8">
              Subscribe to our newsletter to receive the latest insights and
              updates on AI, automation, and digital innovation.
            </p>
