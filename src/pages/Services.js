          ...
          <div className="relative w-full h-80 mb-8">
            <svg className="w-full h-full" viewBox="0 0 800 400" xmlns="http://www.w3.org/2000/svg">
              <defs>
                ...
                <linearGradient id="webGradient2" x1="0%" y1="0%" x2="100%" y2="0%">
              ...
              {/* Background Elements */}
              <circle cx="100" cy="100" r="60" fill="url(#webGradient1)" opacity="0.1" className="animate-pulse">
                <animate attributeName="r" values="60;80;60" dur="3s" repeatCount="indefinite"/>
              </circle>
              <circle cx="700" cy="300" r="40" fill="url(#webGradient2)" opacity="0.15" className="animate-pulse">
                <animate attributeName="r" values="40;60;40" dur="4s" repeatCount="indefinite"/>
              </circle>
              
              {/* Browser Window */}
              <rect x="150" y="80" width="500" height="320" rx="12" fill="white" stroke="#E5E7EB" strokeWidth="2" filter="url(#glow)"/>
              <rect x="150" y="80" width="500" height="40" rx="12" fill="#F3F4F6"/>
              <circle cx="175" cy="100" r="6" fill="#EF4444"/>
              <circle cx="195" cy="100" r="6" fill="#F59E0B"/>
              <circle cx="215" cy="100" r="6" fill="#10B981"/>
              
              {/* Website Content */}
              <rect x="180" y="140" width="120" height="8" rx="4" fill="url(#webGradient1)"/>
              <rect x="180" y="160" width="200" height="6" rx="3" fill="#D1D5DB"/>
              <rect x="180" y="175" width="150" height="6" rx="3" fill="#D1D5DB"/>
              
              {/* Interactive Elements */}
              <rect x="180" y="200" width="100" height="60" rx="8" fill="url(#webGradient1)" opacity="0.8">
                <animate attributeName="opacity" values="0.8;1;0.8" dur="2s" repeatCount="indefinite"/>
              </rect>
              <rect x="300" y="200" width="100" height="60" rx="8" fill="url(#webGradient2)" opacity="0.8">
                <animate attributeName="opacity" values="0.8;1;0.8" dur="2.5s" repeatCount="indefinite"/>
              </rect>
              <rect x="420" y="200" width="100" height="60" rx="8" fill="#A855F7" opacity="0.8">
                <animate attributeName="opacity" values="0.8;1;0.8" dur="3s" repeatCount="indefinite"/>
              </rect>
              
              {/* Code Elements */}
              <text x="180" y="300" fontSize="12" fill="#6B7280" fontFamily="monospace">&lt;div className="interactive"&gt;</text>
              <text x="180" y="320" fontSize="12" fill="#6B7280" fontFamily="monospace">  &lt;Component animate /&gt;</text>
              <text x="180" y="340" fontSize="12" fill="#6B7280" fontFamily="monospace">&lt;/div&gt;</text>
              
              {/* Floating Icons */}
              <g transform="translate(680, 60)">
                <circle r="25" fill="url(#webGradient1)" opacity="0.2"/>
                <path d="M-8,-8 L8,-8 L8,8 L-8,8 Z M-6,-6 L6,-6 M-6,-2 L6,-2 M-6,2 L6,2 M-6,6 L2,6" stroke="url(#webGradient1)" strokeWidth="2" fill="none"/>
                <animateTransform attributeName="transform" type="rotate" values="0;360" dur="10s" repeatCount="indefinite"/>
              </g>
              
              <g transform="translate(60, 320)">
                <circle r="20" fill="url(#webGradient2)" opacity="0.2"/>
                <path d="M-6,-6 L6,6 M6,-6 L-6,6" stroke="url(#webGradient2)" strokeWidth="2"/>
        ...
        return (
          <div className="relative w-full h-80 mb-8">
            <svg className="w-full h-full" viewBox="0 0 800 400" xmlns="http://www.w3.org/2000/svg">
              ...
              <rect x="50" y="50" width="700" height="300" rx="20" fill="white" stroke="#E5E7EB" strokeWidth="2" filter="url(#shadow)"/>
              
              {/* Header */}
              <rect x="70" y="70" width="150" height="15" rx="7" fill="url(#dataGradient1)"/>
              <rect x="70" y="95" width="200" height="8" rx="4" fill="#D1D5DB"/>
              
              {/* Charts */}
              {/* Bar Chart */}
              <g transform="translate(100, 150)">
                {[40, 70, 55, 85, 60, 90, 45].map((height, i) => (
                  <rect key={i} x={i * 25} y={120 - height} width="20" height={height} fill="url(#dataGradient1)" opacity="0.8" rx="2">
                    <animate attributeName="height" values={`0;${height};0;${height}`} dur="4s" begin={`${i * 0.2}s`} repeatCount="indefinite"/>
                    <animate attributeName="y" values={`120;${120 - height};120;${120 - height}`} dur="4s" begin={`${i * 0.2}s`} repeatCount="indefinite"/>
                  </rect>
                ))}
              </g>
              ...
              <g transform="translate(350, 150)">
                <polyline points="0,80 30,60 60,40 90,20 120,35 150,15 180,25" 
                ...
                {[80, 60, 40, 20, 35, 15, 25].map((y, i) => (
                  <circle key={i} cx={i * 30} cy={y} r="4" fill="url(#dataGradient2)">
              ...
              <g transform="translate(600, 200)">
                ...
                <circle r="50" fill="none" stroke="url(#dataGradient1)" strokeWidth="8" 
                       strokeDasharray="157" strokeDashoffset="118" transform="rotate(-90)">
                  <animate attributeName="stroke-dashoffset" values="157;39;157" dur="3s" repeatCount="indefinite"/>
                </circle>
                <circle r="50" fill="none" stroke="url(#dataGradient2)" strokeWidth="8" 
                       strokeDasharray="157" strokeDashoffset="79" transform="rotate(45)">
                  <animate attributeName="stroke-dashoffset" values="157;79;157" dur="3.5s" repeatCount="indefinite"/>
                </circle>
              </g>
          ...
          <div className="relative w-full h-80 mb-8">
            <svg className="w-full h-full" viewBox="0 0 800 400" xmlns="http://www.w3.org/2000/svg">
              ...
              <g transform="translate(400, 200)">
                <circle r="80" fill="url(#aiGradient1)" opacity="0.1" filter="url(#aiGlow)">
                ...
                {Array.from({length: 8}).map((_, i) => {
                  ...
                  return (
                    <g key={i}>
                      <line x1="0" y1="0" x2={x} y2={y} stroke="url(#aiGradient1)" strokeWidth="2" opacity="0.6">
                      ...
                      <circle cx={x} cy={y} r="6" fill="url(#aiGradient2)">
                        <animate attributeName="r" values="6;10;6" dur="2s" begin={`${i * 0.25}s`} repeatCount="indefinite"/>
                      </circle>
                    </g>
                  );
                })}
              ...
              <g transform="translate(150, 100)">
                <rect width="120" height="80" rx="12" fill="white" stroke="url(#aiGradient1)" strokeWidth="2" opacity="0.9"/>
                <text x="60" y="25" textAnchor="middle" fontSize="12" fill="url(#aiGradient1)" fontWeight="bold">Voice Agent</text>
                <circle cx="30" cy="50" r="8" fill="url(#aiGradient1)" opacity="0.3">
                  <animate attributeName="r" values="8;12;8" dur="1.5s" repeatCount="indefinite"/>
                </circle>
                <circle cx="60" cy="50" r="8" fill="url(#aiGradient1)" opacity="0.5">
                  <animate attributeName="r" values="8;12;8" dur="1.8s" repeatCount="indefinite"/>
                </circle>
                <circle cx="90" cy="50" r="8" fill="url(#aiGradient1)" opacity="0.7">
                  <animate attributeName="r" values="8;12;8" dur="2.1s" repeatCount="indefinite"/>
                </circle>
              </g>
              
              <g transform="translate(530, 100)">
                <rect width="120" height="80" rx="12" fill="white" stroke="url(#aiGradient2)" strokeWidth="2" opacity="0.9"/>
                <text x="60" y="25" textAnchor="middle" fontSize="12" fill="url(#aiGradient2)" fontWeight="bold">Avatar Agent</text>
                <circle cx="60" cy="50" r="15" fill="none" stroke="url(#aiGradient2)" strokeWidth="2">
                  <animate attributeName="stroke-dasharray" values="0,94;47,47;0,94" dur="3s" repeatCount="indefinite"/>
                </circle>
                <circle cx="60" cy="50" r="8" fill="url(#aiGradient2)" opacity="0.6"/>
              </g>
              
              <g transform="translate(150, 280)">
                <rect width="120" height="80" rx="12" fill="white" stroke="url(#aiGradient1)" strokeWidth="2" opacity="0.9"/>
                <text x="60" y="25" textAnchor="middle" fontSize="12" fill="url(#aiGradient1)" fontWeight="bold">Creative Agent</text>
                <path d="M30,40 Q45,30 60,40 Q75,50 90,40 Q75,60 60,50 Q45,60 30,50 Q45,40 60,50" 
                      fill="none" stroke="url(#aiGradient1)" strokeWidth="2">
              ...
              <g transform="translate(530, 280)">
                <rect width="120" height="80" rx="12" fill="white" stroke="url(#aiGradient2)" strokeWidth="2" opacity="0.9"/>
                <text x="60" y="25" textAnchor="middle" fontSize="12" fill="url(#aiGradient2)" fontWeight="bold">Analytics Agent</text>
                {[0, 1, 2].map(i => (
                  <rect key={i} x={30 + i * 20} y={60 - (i + 1) * 5} width="8" height={(i + 1) * 5} fill="url(#aiGradient2)" opacity="0.7">
                    <animate attributeName="height" values={`${(i + 1) * 5};${(i + 1) * 8};${(i + 1) * 5}`} dur="2s" begin={`${i * 0.3}s`} repeatCount="indefinite"/>
                  </rect>
                ))}
              </g>
              
              {/* Connection Lines */}
              <line x1="270" y1="140" x2="320" y2="180" stroke="url(#aiGradient1)" strokeWidth="2" opacity="0.4" strokeDasharray="5,5">
                <animate attributeName="stroke-dashoffset" values="0;10" dur="1s" repeatCount="indefinite"/>
              </line>
              <line x1="530" y1="140" x2="480" y2="180" stroke="url(#aiGradient2)" strokeWidth="2" opacity="0.4" strokeDasharray="5,5">
                <animate attributeName="stroke-dashoffset" values="0;10" dur="1s" repeatCount="indefinite"/>
              </line>
              <line x1="270" y1="320" x2="320" y2="280" stroke="url(#aiGradient1)" strokeWidth="2" opacity="0.4" strokeDasharray="5,5">
                <animate attributeName="stroke-dashoffset" values="0;10" dur="1s" repeatCount="indefinite"/>
              </line>
              <line x1="530" y1="320" x2="480" y2="280" stroke="url(#aiGradient2)" strokeWidth="2" opacity="0.4" strokeDasharray="5,5">
                <animate attributeName="stroke-dashoffset" values="0;10" dur="1s" repeatCount="indefinite"/>
              </line>
            </svg>
          </div>
      ...
      case "intelligent-automation":
        return (
          <div className="relative w-full h-80 mb-8">
            <svg className="w-full h-full" viewBox="0 0 800 400" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient id="autoGradient1" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#2563EB" />
                  <stop offset="100%" stopColor="#4F46E5" />
                </linearGradient>
                <linearGradient id="autoGradient2" x1="0%" y1="0%" x2="100%" y2="0%">
              ...
              <g transform="translate(50, 150)">
                {/* Input */}
                <rect x="0" y="0" width="80" height="60" rx="10" fill="white" stroke="url(#autoGradient1)" strokeWidth="2"/>
                <text x="40" y="25" textAnchor="middle" fontSize="10" fill="url(#autoGradient1)" fontWeight="bold">INPUT</text>
                <text x="40" y="40" textAnchor="middle" fontSize="8" fill="#6B7280">Data Source</text>
                
                {/* Processing Steps */}
                {[1, 2, 3, 4].map((step, i) => (
                  <g key={i} transform={`translate(${140 + i * 120}, 0)`}>
                    <rect width="80" height="60" rx="10" fill="url(#autoGradient1)" opacity="0.1" stroke="url(#autoGradient1)" strokeWidth="2">
                      <animate attributeName="opacity" values="0.1;0.3;0.1" dur="2s" begin={`${i * 0.5}s`} repeatCount="indefinite"/>
                    </rect>
                    <text x="40" y="25" textAnchor="middle" fontSize="10" fill="url(#autoGradient1)" fontWeight="bold">STEP {step}</text>
                    <text x="40" y="40" textAnchor="middle" fontSize="8" fill="#6B7280">Process</text>
                    
                    {/* Gear Animation */}
                    <g transform="translate(40, 48)">
                      <circle r="8" fill="none" stroke="url(#autoGradient1)" strokeWidth="1" opacity="0.5">
                        <animateTransform attributeName="transform" type="rotate" values="0;360" dur={`${2 + i * 0.3}s`} repeatCount="indefinite"/>
                      </circle>
                      <path d="M-4,-2 L4,-2 L4,2 L-4,2 Z M-2,-4 L2,-4 L2,4 L-2,4 Z" fill="url(#autoGradient1)" opacity="0.7">
                        <animateTransform attributeName="transform" type="rotate" values="0;360" dur={`${2 + i * 0.3}s`} repeatCount="indefinite"/>
                      </path>
                    </g>
                  </g>
                ...
                <g transform="translate(680, 0)">
                  <rect width="80" height="60" rx="10" fill="url(#autoGradient2)" opacity="0.9" stroke="url(#autoGradient2)" strokeWidth="2"/>
                  <text x="40" y="25" textAnchor="middle" fontSize="10" fill="white" fontWeight="bold">OUTPUT</text>
                  <text x="40" y="40" textAnchor="middle" fontSize="8" fill="white" opacity="0.8">Result</text>
                </g>
                
                {/* Flow Arrows */}
                {[0, 1, 2, 3, 4].map((_, i) => (
                  <g key={i} transform={`translate(${100 + i * 120}, 30)`}>
                    <path d="M0,0 L20,0 M15,-5 L20,0 L15,5" stroke="url(#autoGradient1)" strokeWidth="2" fill="none">
                      <animate attributeName="stroke-dasharray" values="0,30;15,15;0,30" dur="1.5s" begin={`${i * 0.2}s`} repeatCount="indefinite"/>
                    </path>
                  </g>
                ))}
              </g>
              ...
              <g transform="translate(100, 50)">
                ...
                <rect x="-15" y="-15" width="30" height="30" rx="5" fill="none" stroke="url(#autoGradient1)" strokeWidth="2"/>
                ...
                <rect x="-6" y="0" width="12" height="8" rx="2" fill="url(#autoGradient1)" opacity="0.7"/>
              </g>
              
              <g transform="translate(700, 50)">
                <circle r="25" fill="url(#autoGradient2)" opacity="0.1"/>
                <path d="M-12,-12 L12,-12 L12,12 L-12,12 Z M-8,-8 L8,-8 M-8,0 L8,0 M-8,8 L8,8" stroke="url(#autoGradient2)" strokeWidth="2" fill="none"/>
                <circle cx="0" cy="0" r="6" fill="url(#autoGradient2)" opacity="0.3">
              ...
              {Array.from({length: 15}).map((_, i) => (
                <circle key={i} 
                       ...
                       opacity="0.2">
                  <animate attributeName="cy" values={`${250 + Math.random() * 100};${200 + Math.random() * 50};${250 + Math.random() * 100}`} dur={`${3 + Math.random() * 2}s`} repeatCount="indefinite"/>
              ...
              <div className="sticky top-0 bg-gradient-to-r from-gray-50 to-white/95 backdrop-blur-md z-20 border-b border-gray-100 shadow-sm">
                <div className="px-6 sm:px-8 py-4 flex items-center justify-between relative">
                  ...
                  <button 
                    ...
                    onClick={closeModal}
                  >
                    <svg className="w-6 h-6 text-gray-500 group-hover:text-gray-700 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="animate-on-scroll">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        {selectedService.offerings.map((item, i) => (
                          <Fade direction="up" delay={i * 150} cascade triggerOnce key={`${selectedService.id}-offering-${item.title}`}>
                            <div className="group bg-white rounded-2xl p-8 shadow-md border border-gray-100 hover:shadow-xl transition-all duration-500 relative overflow-hidden">
                              ...
                              <div className="flex items-start relative z-10">
                                ...
                                <div className="flex-1">
                                  <h4 className="text-theme-purple font-bold text-xl mb-4 group-hover:text-theme-blue transition-colors duration-300">{item.title}</h4>
                          ...
                          <Fade direction="up" delay={i * 100} cascade triggerOnce key={generateUniqueId(`${selectedService.id}-bullet`, item)}>
                            <div className="group bg-white rounded-2xl p-6 shadow-md border border-gray-100 hover:shadow-xl transition-all duration-500 relative overflow-hidden">
                              ...
                              <div className="flex items-start relative z-10">
                                ...
                                <span className="text-gray-700 flex-1 leading-relaxed group-hover:text-gray-800 transition-colors duration-300">{item}</span>
                              </div>
                            </div>
                          </Fade>
                        ))}
                    ...
                    <div className="animate-on-scroll">
                      ...
                      <div className="space-y-8">
                        {selectedService.approaches.map((approach, i) => (
                          <Fade direction="up" delay={i * 200} triggerOnce key={`${selectedService.id}-approach-${approach.title}`}>
                              ...
                              <div className="pl-8 relative z-10">
                                <h4 className="text-theme-purple font-bold flex items-center text-2xl mb-6 group-hover:text-theme-blue transition-colors duration-300">
                                  <span className="w-14 h-14 rounded-2xl bg-gradient-to-r from-theme-blue/10 to-theme-purple/10 flex items-center justify-center mr-4 group-hover:from-theme-blue/20 group-hover:to-theme-purple/20 transition-all duration-300">
                                    <svg className="w-7 h-7 text-theme-purple group-hover:text-theme-blue transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z"></path>
                                    </svg>
                                  </span>
                                  {approach.title}
                                </h4>
                                <p className="text-gray-700 mb-6 text-lg leading-relaxed">{approach.description}</p>
                                ...
                                {approach.examples && approach.examples.length > 0 && (
                                  <div className="mt-6 p-6 bg-gradient-to-r from-gray-50 to-white rounded-2xl border border-gray-100 group-hover:shadow-md transition-all duration-300">
                                    <p className="text-gray-700 font-semibold mb-6 flex items-center text-lg">
                                      <svg className="w-6 h-6 mr-3 text-theme-purple" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="space-y-4">
                                      {approach.examples.map((example, j) => (
                                        ...
                                        >
                                          ...
                                          <span className="text-gray-700 flex-1 leading-relaxed">{example}</span>
                                        </div>
                                      ))}
                                    </div>
                                  </div>
                          ...
                          <Fade direction="up" delay={300} triggerOnce>
                            <div className="p-8 rounded-3xl bg-gradient-to-r from-theme-blue/10 to-theme-purple/10 border-l-4 border-theme-purple shadow-lg relative overflow-hidden">
                              ...
                              <div className="flex items-center relative z-10">
                                ...
                                <p className="text-gray-800 font-semibold text-xl leading-relaxed">{selectedService.synergy}</p>
                              </div>
                            </div>
                          </Fade>
                        )}
                          ...
                          <Fade direction="up" delay={i * 150} triggerOnce key={generateUniqueId(`${selectedService.id}-whyus`, item)}>
                            <div className="group bg-white rounded-2xl p-8 shadow-md border border-gray-100 hover:shadow-xl transition-all duration-500 relative overflow-hidden">
                              ...
                              <div className="flex items-start relative z-10">
                                ...
                                <div className="flex-1">
                                  <span className="text-gray-800 font-bold text-xl block mb-2">{item.split(':')[0]}:</span>
                                  <span className="text-gray-700 text-lg leading-relaxed">{item.split(':')[1] || item}</span>
                                </div>
                              </div>
                            </div>
                          </Fade>
                  ...
                  <div className="mt-16 rounded-3xl overflow-hidden shadow-2xl relative">
                    ...
                    <div className="relative bg-gradient-to-br from-theme-blue via-theme-purple to-pink-500 p-12 text-center">
                      <div className="max-w-4xl mx-auto relative z-10">
                        <h3 className="text-white font-bold text-4xl mb-6">Ready to Transform Your Business?</h3>
                        <p className="text-white/90 text-xl mb-10 leading-relaxed">
                          Our expert team is ready to implement cutting-edge {selectedService.title.toLowerCase()} solutions for your organization. Let's create something incredible together.
                        </p>
