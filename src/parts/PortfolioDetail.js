...
export default function PortfolioDetail({ data }) {
        ...
        <Fade bottom triggerOnce>
          <div className="flex flex-col w-full justify-center">
            ...
            <div className="flex justify-center">
              <Button href="/project" type="link" className="flex w-30 h-10 px-5 mt-5  text-white items-center rounded transform transition duration-500 hover:bg-gray-900">
                Go Back
              </Button>
            </div>
          </div>
  ...
  return (
    <section className="container mx-auto">
      <Fade bottom>
        <Button type="link" href="/project" className="flex w-40 h-8 text-lg items-center ml-6 sm:ml-20 mt-8 font-light  hover:underline">
...

      {
        data.map((item) => (
          <div className="flex flex-col mt-8 justify-center">
            <Fade bottom triggerOnce>
              <h1 className="text-5xl  text-center font-bold">{item.title}</h1>

              <p className="font-light text-xl  text-center mb-10">
                {item.type}
              </p>
            </Fade>
            ...
            <Fade bottom delay={300 * 1} triggerOnce>
              ...
              <p className="font-light italic  mt-16 mx-8 sm:mx-16 xl:mx-28">
